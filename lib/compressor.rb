...
def compressSchedulr
  ...
  javascripts = ['external/jquery', 'baseExtensions', 'external/base', 'external/string', 'jQueryExtensions', 'config', 'production', 'external/shadowbox', 'haml2', 'views', 'external/cookie', 'stacktrace', 'messages', 'dates', 'conflictDialog', 'schedule', 'sharedSchedule', 'scheduleManager', 'gcalManager', 'drilldownFilters', 'drilldown', 'help', 'search', 'enrollment', 'registerDialog', 'feedback', 'tooltips', 'drilldownFiltersImpl', 'application']
